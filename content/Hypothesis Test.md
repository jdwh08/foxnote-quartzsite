...
---
### Definition:
Statistical tool used to check whether the data support a particular hypothesis.
...
4. Calculate your test statistic given the null hypothesis is true, and the associated P-value (probability of observing a test statistic as extreme or more extreme). 
...
**Link to A/B Testing**
For #ds, companies will typically want to test features using [[A/B Testing]], which gets its theoretical underpinnings from hypothesis testing.
