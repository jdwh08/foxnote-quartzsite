...
If mutual information is zero, we know that the two variables tell nothing about each other, i.e., [[Independent Events|independent]].
...
- I.e., a measure of the difference between [[Joint Probability]] and individual probabilities. These are the same iff [[Independent Events|independent]].
