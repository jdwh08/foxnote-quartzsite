...
##### Overfitting
As the number of models increases, model expressiveness increases because we are constantly "learning" the past error.
- Thus, we can potentially [[Overfitting|Overfit]] as the number of trees grows, unlike in [[Bootstrap Aggregating|Bagging]] or [[Random Forests]].
- However, this is surprisingly not that common, e.g., for [[AdaBoost]] (Schapire et al 1998), which connected it to the idea of maximizing the margin like in [[Support Vector Machines|SVM]].
