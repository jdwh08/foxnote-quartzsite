...
2. It is a [[Convex Function]] by the [[Second Derivative Test]].
3. It is bounded between $\max \le LSP \le \max + \log(n)$.

This makes it a reasonable candidate for a differentiable $\max$ function.
